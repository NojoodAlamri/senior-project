...
class Editepackage extends StatefulWidget {
  final ID_doc;
  final data;
  const Editepackage({super.key, this.ID_doc, this.data});

  @override
  State<Editepackage> createState() => _EditepackageState();
}

class _EditepackageState extends State<Editepackage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("  تعديل باقة ")),
      body: Container(
        child: ListView(
          children: [
            Container(
